...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = audio_formatter
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = gpio1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER HW_INSTANCE = hdmi_dynclk
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_vdma
 PARAMETER HW_INSTANCE = hdmi_vdma
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER HW_INSTANCE = hdmi_vtc
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_iic
 PARAMETER HW_INSTANCE = i2c2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = i2s_receiver
 PARAMETER HW_INSTANCE = i2s_receiver
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = i2s_transmitter
 PARAMETER HW_INSTANCE = i2s_transmitter
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_vdma
 PARAMETER HW_INSTANCE = lcd_vdma
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER HW_INSTANCE = lcd_vtc
END
